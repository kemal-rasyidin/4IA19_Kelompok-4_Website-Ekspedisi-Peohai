        ...
        <div class="py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div>
                    ...
                    <div class="flex gap-4 mt-6">
                        <a href="#" class="bg-white/10 hover:bg-orange-500 rounded-full p-3 transition-colors duration-300">
            ...
            <div class="border-t border-white/10 mt-8 pt-6">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p class="text-sm text-gray-300">
                        © 2025 <span class="font-semibold text-white">PT. Peohai Mitra Sejati</span>. All rights reserved.
                    </p>
                    <div class="flex gap-6 text-sm">
                        <a href="#" class="text-gray-300 hover:text-orange-400 transition-colors">Privacy Policy</a>
                        <a href="#" class="text-gray-300 hover:text-orange-400 transition-colors">Terms of Service</a>
                    </div>
                </div>
            </div>
        </div>
...
<a href="https://wa.me/6285281761717?text=Halo%20Ekspedisi%20Peohai,%20saya%20ingin%20bertanya%20tentang%20layanan%20pengiriman" 
   ...
   class="fixed bottom-6 left-6 z-50 group">
    ...
    <!-- Button Container -->
    <div class="relative flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-2xl transition-all duration-300 hover:scale-110 px-4 py-3">
        <!-- Icon WhatsApp -->
