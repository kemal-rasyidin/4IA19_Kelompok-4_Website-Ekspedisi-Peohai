<x-admin.layout>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div
                class="bg-white rounded-lg shadow-md p-6 border-l-4 {{ $keuntungan_bersih >= 0 ? 'border-purple-500' : 'border-orange-500' }}">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600">Keuntungan Bersih</p>
                        <p
                            class="text-2xl font-bold {{ $keuntungan_bersih >= 0 ? 'text-purple-600' : 'text-orange-600' }} mt-2">
                            Rp {{ number_format($keuntungan_bersih, 0, ',', '.') }}
                        </p>
                    </div>
                    <div class="bg-{{ $keuntungan_bersih >= 0 ? 'purple' : 'orange' }}-100 rounded-full p-3">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-8 w-8 text-{{ $keuntungan_bersih >= 0 ? 'purple' : 'orange' }}-600" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex justify-end space-x-2">
            <a
                href="{{ route('marketing.entries.export', $entry_period) }}"class="inline-flex items-center px-4 py-2 border border-yellow-500 bg-blue-50 text-yellow-600 hover:text-white hover:bg-yellow-500 font-medium rounded-md shadow-md">
