<x-home>
        ...
        <div class="container relative z-10">
            <div class="mb-10 flex flex-wrap text-center">
                <div class="w-full">
                    ...
                    <p class="mb-4 text-5xl lg:text-6xl font-bold leading-tight tracking-wide text-white drop-shadow-lg"
                ...
                <div class="w-full flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="/simulasi-tarif"
                        class="inline-block px-8 py-4 text-lg font-semibold text-white bg-blue-500 rounded-full duration-300 ease-in-out hover:bg-blue-600 hover:shadow-2xl transform hover:scale-105 min-w-[200px] text-center">
                        Cek Tarif Pengiriman
                    </a>
                    <a href="/lacak"
                        class="inline-block px-8 py-4 text-lg font-semibold text-white bg-transparent border-2 border-white rounded-full duration-300 ease-in-out hover:bg-white hover:text-blue-900 hover:shadow-2xl transform hover:scale-105 min-w-[200px] text-center">
                        Lacak Pengiriman
                    </a>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-6 items-stretch">
                    ...
                    <div class="col-span-1 lg:col-span-1 h-full">
                        <div class="grid grid-cols-2 lg:grid-cols-1 gap-6 h-full">
                            <div
                                class="rounded-lg bg-orange-500 p-8 flex flex-col justify-center text-center h-full shadow-xl hover:shadow-2xl transition-shadow">
                                <h5 class="mb-2 text-3xl font-bold tracking-tight text-white">100+</h5>
                                <p class="font-medium text-gray-50">Pelanggan</p>
                            </div>
                            <div
                                class="rounded-lg bg-blue-500 p-8 flex flex-col justify-center text-center h-full shadow-xl hover:shadow-2xl transition-shadow">
        ...
        <div class="container">
            ...
            <div class="mb-8 text-center">
                ...
                <p class="mt-4 max-w-2xl mx-auto text-slate-500">
                    Layanan kami dibangun untuk memastikan keamanan, ketepatan waktu, dan kepercayaan dalam setiap
                    pengiriman.
                </p>
            </div>
            ...
            <div class="grid gap-6 sm:grid-cols-3">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-slate-500">
                                Barang Anda dilindungi dengan prosedur keamanan ketat dan pilihan asuransi untuk jaminan
                                pengiriman.
                            </p>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-start gap-4">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 shrink-0">
                            <!-- icon: truck -->
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-slate-500">
                                Didukung jaringan mitra pelayaran dan trucking berpengalaman yang memastikan pengiriman
                                tepat waktu.
                            </p>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-start gap-4">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-lg bg-amber-50 text-amber-600 shrink-0">
                            <!-- icon: thumbs-up -->
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
    ...
    <section id="contact" class="py-8">
        <div class="container">
            <div class="bg-ink rounded-xl p-10">
                <div class="flex flex-wrap">
                    <div class="mb-8 w-full">
                        <h2 class="text-4xl font-bold text-white">Tentang Kami</h2>
                        <div class="mt-3 h-1 w-24 bg-amber-500 rounded-full"></div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                    ...
                    <div class="hidden lg:block lg:col-span-6">
                        <img src="https://images.unsplash.com/photo-1587293852726-70cdb56c2866?auto=format&fit=crop&q=80&w=1172"
                            alt="Gudang dan operasional logistik PT. Peohai Mitra Sejati"
                            class="h-[400px] w-full rounded-xl object-cover shadow-md" />
                    </div>

                    <!-- Konten -->
                    <div class="col-span-12 lg:col-span-6 space-y-6">
                        <p class="text-white text-base leading-relaxed">
                            <strong class="text-white">PT. Peohai Mitra Sejati</strong> telah beroperasi sejak tahun
                            <strong class="text-white">2015</strong> dan menyediakan layanan ekspedisi berbasis
                            kontainer untuk pengiriman
                            antar kota dan antar pulau di Indonesia. Kami menekankan keandalan, keamanan barang, dan
                            transparansi layanan
                            untuk mendukung kebutuhan logistik pelanggan komersial maupun UMKM.
                        </p>

                        <p class="text-slate-300 text-base leading-relaxed">
                            Untuk informasi layanan atau permintaan penawaran, silakan hubungi kami melalui WhatsApp
                            atau
                            lihat informasi singkat di Instagram resmi kami. Tim admin kami siap membantu estimasi biaya
                            dan proses
                            pengiriman.
                        </p>
                        ...
                        <div class="flex flex-wrap gap-3">
                            <a href="https://wa.me/6285281761717" target="_blank" rel="noopener noreferrer"
                                class="inline-flex items-center gap-2 rounded-full bg-green-500 px-5 py-3 text-sm font-medium text-white shadow hover:bg-green-600 transition">
                                <!-- WhatsApp icon -->
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                    <path
                                        d="M20.52 3.48A11.94 11.94 0 0012 0C5.373 0 0 5.373 0 12c0 2.11.55 4.08 1.6 5.83L0 24l6.41-1.61A11.94 11.94 0 0012 24c6.627 0 12-5.373 12-12 0-3.21-1.25-6.16-3.48-8.52zM12 21.5c-1.8 0-3.56-.46-5.1-1.33l-.36-.2-3.8.97.98-3.7-.23-.38A9.5 9.5 0 012.5 12 9.5 9.5 0 1112 21.5z" />
                                    <path
                                        d="M17.3 14.2c-.3-.15-1.8-.9-2.08-1s-.48-.15-.68.15-.78 1-.96 1.2-.35.22-.65.07c-.3-.15-1.26-.46-2.4-1.47-.89-.79-1.49-1.76-1.66-2.06-.17-.3-.02-.46.13-.61.13-.13.3-.34.45-.51.15-.17.2-.28.3-.46.1-.17.05-.33-.02-.47-.08-.1-.68-1.64-.93-2.25-.24-.59-.48-.51-.66-.52l-.56-.01c-.2 0-.52.07-.8.33-.28.26-1.07 1.04-1.07 2.53s1.1 2.94 1.25 3.15c.15.2 2.12 3.24 5.14 4.54 3.02 1.3 3.02.87 3.56.82.54-.05 1.76-.72 2.01-1.41.25-.69.25-1.28.18-1.41-.07-.13-.26-.2-.56-.34z" />
                                </svg>
                                Chat WhatsApp
                            </a>

                            <a href="https://www.instagram.com/peohaimitrasejati/" target="_blank"
                                rel="noopener noreferrer"
                                class="inline-flex items-center gap-2 rounded-full bg-[#8a49a1] px-5 py-3 text-sm font-medium text-white shadow hover:bg-[#c1558b] transition">
                                <!-- Instagram icon -->
                        ...
                        <div class="pt-4 text-sm text-slate-400">
                            <p class="mb-1"><strong class="text-slate-200">WhatsApp:</strong> <a
                                    href="https://wa.me/6285281761717" class="text-green-500 hover:underline"
                                    target="_blank">+62 852-8176-1717</a></p>
                            <p class="mb-0"><strong class="text-slate-200">Alamat:</strong> Ciherang Hills
                                Residence, Blok F No.01,
                                Sukatani, Depok, Jawa Barat 16454</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="text-center mb-16 lg:mb-20">
                <div class="inline-flex items-center gap-3 mb-4">
                    ...
                    <span
                        class="text-sm font-semibold uppercase tracking-wider text-blue-600 bg-blue-50 px-3 py-1 rounded-full">
                        Layanan Unggulan
                    </span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mx-auto">
                ...
                <div
                    ...
                    <!-- Decorative Corner -->
                    <div
                        class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-blue-500/10 to-emerald-500/10 rounded-bl-full">
                    </div>
                    ...
                    <div class="p-8 lg:p-10">
                        ...
                        <div class="flex items-start justify-between mb-6">
                            ...
                            <span
                                class="px-3 py-1 text-sm font-semibold text-white bg-gradient-to-r from-blue-500 to-blue-600 rounded-full">
                                Paling Populer
                            </span>
                        </div>
                        ...
                        <div
                            class="relative mb-8 overflow-hidden rounded-xl group-hover:scale-[1.02] transition-transform duration-500 bg-gradient-to-br from-slate-50 to-blue-50">
                            <div class="flex items-center justify-center h-[280px] lg:h-[320px] p-4">
                                <img src="/img/20ft.png" alt="Container 20ft - Pengiriman Standar"
                ...
                <div
                    ...
                    <!-- Decorative Corner -->
                    <div
                        class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-emerald-500/10 to-blue-500/10 rounded-bl-full">
                    </div>
                    ...
                    <div class="p-8 lg:p-10">
                        ...
                        <div class="flex items-start justify-between mb-6">
                            <div class="flex items-center gap-4">
                                <div
                                    ...
                                    <svg class="w-8 h-8 text-white" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path fill="currentColor"
                                            d="M19 8H5v11h14zm-3-5v2H8V3H6v2H5a2 2 0 00-2 2v12a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 00-2-2h-1V3z" />
                                    </svg>
                                </div>
                                <div>
                            ...
                            <span
                                class="px-3 py-1 text-sm font-semibold text-white bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full">
                                Kapasitas Besar
                            </span>
                        </div>
                        ...
                        <!-- Image Container - Diperbesar -->
                        <div
                            class="relative mb-8 overflow-hidden rounded-xl group-hover:scale-[1.02] transition-transform duration-500 bg-gradient-to-br from-slate-50 to-emerald-50">
                            <div class="flex items-center justify-center h-[280px] lg:h-[320px] p-4">
                                <img src="/img/40ft.png" alt="Container 40ft - Pengiriman Kapasitas Besar"
                                    class="w-full h-full object-contain rounded-lg"
                    ...
                    <table class="w-full">
                        <thead class="bg-slate-50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-center text-sm font-semibold text-blue-600">Container 20ft
                                </th>
                                <th class="px-6 py-4 text-center text-sm font-semibold text-emerald-600">Container 40ft
                                </th>
                            </tr>
                        </thead>
